...
- **단점 1**: **fork 는 부모 네트워크 레포** 로 관리됨. 검색 · starring · 브랜드 식별에서 "storkspear/template-flutter 의 포크" 로 계속 보여요. 독립 브랜드가 아님.
...
- [`template-spring 의 ADR-002`](https://github.com/storkspear/template-spring/blob/main/docs/journey/philosophy/adr-002-use-this-template.md) — 짝이 되는 백엔드 템플릿의 같은 결정. 프롤로그 제약 공유
