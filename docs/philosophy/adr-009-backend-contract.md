...
**계약 구현** (클라이언트)
- [`lib/kits/backend_api_kit/api_response.dart`](https://github.com/storkspear/template-flutter/blob/main/lib/kits/backend_api_kit/api_response.dart) — `ApiResponse<T>` · `ApiError` · `PageResponse<T>` (75줄)
- [`lib/kits/backend_api_kit/error_code.dart`](https://github.com/storkspear/template-flutter/blob/main/lib/kits/backend_api_kit/error_code.dart) — 에러 코드 상수 (61줄)
- [`lib/kits/backend_api_kit/api_exception.dart`](https://github.com/storkspear/template-flutter/blob/main/lib/kits/backend_api_kit/api_exception.dart) — `ApiException` + `safeErrorCode` / `safeErrorMessage` (83줄)
